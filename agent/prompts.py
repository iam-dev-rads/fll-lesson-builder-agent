...
5. STRUCTURE:
   - Decide between 8 to 10 slides based on the complexity of "{concept}". (Simple concept = 8 slides, complex = 10 slides).
...
{{
  ...
  "slides": [
    {{
      ...
      "example": "A real-world example related to this specific slide",
...
- Ensure every slide in the "slides" list has "bullet_points", "example", and "speaker_note" fields.
